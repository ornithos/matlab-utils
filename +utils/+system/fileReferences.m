function [unresolved, assigned, called, ll, assinFn] = fileReferences(fname, MATLABorR, bIgnoreFnBody)
    ...
    while ischar(tline)
        ...
        if isR && fncounter > 0
            [pos, fncounter] = findMatchingCharacter(inpLine, charOpen, charClose, fncounter);
            if pos > 0
                fndef = 0;
